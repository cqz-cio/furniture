...
const messages = {
  en: {
    ...
    productsSubtitle: "Live product data from Yudao; production shows a clear unavailable state when the backend is offline.",
  ...
  "zh-CN": {
    ...
    viewDetails: "查看详情",
    productsTitle: "家具系列",
    productsSubtitle: "优先读取 Yudao 商品数据；生产环境后端离线时显示明确不可用状态。",
    productDetail: "商品详情",
  ...
  fr: {
    ...
    productsSubtitle: "Données produit Yudao en direct; en production, une indisponibilité claire s'affiche si le backend est hors ligne.",
