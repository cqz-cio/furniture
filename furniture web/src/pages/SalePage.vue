...
<template>
  <section class="sale-hero">
    <picture class="sale-hero-picture">
      ...
      <img
        ...
        alt="Oakved sale room with upholstered seating and warm neutral furnishings"
      />
    </picture>
  ...
  <section class="sale-membership-slot" aria-label="Oakved Members Program sale benefits">
    <picture class="sale-membership-picture">
      ...
      <img
        ...
        alt="Oakved Members Program savings invitation"
      />
    </picture>
  </section>
</template>
