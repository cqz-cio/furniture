...
ErrorCode PURCHASE_ORDER_ITEM_RETURN_FAIL_IN_EXCEED = new ErrorCode(1_030_101_009, "采购订单项({})超过最大允许退货数量({})");
    ...
    ErrorCode WAREHOUSE_DELETE_FAIL_STOCK = new ErrorCode(1_030_400_002, "仓库仍有库存记录，无法删除，请先完成库存清理或停用仓库");
    ErrorCode WAREHOUSE_DELETE_FAIL_BUSINESS_REFERENCE = new ErrorCode(1_030_400_003,
            "仓库已被出入库、采购或销售单据引用，无法删除，请改为停用仓库");
    ...
    ErrorCode PRODUCT_DELETE_FAIL_MALL_MAPPING = new ErrorCode(1_030_500_002,
            "产品仍与网站商品 SKU 关联，无法删除，请先解除商品映射或停用产品");
    ErrorCode PRODUCT_DELETE_FAIL_STOCK = new ErrorCode(1_030_500_003,
            "产品仍有库存记录，无法删除，请先完成库存清理或停用产品");
    ErrorCode PRODUCT_DELETE_FAIL_BUSINESS_REFERENCE = new ErrorCode(1_030_500_004,
            "产品已被采购、销售或库存单据引用，无法删除，请改为停用产品");
    ...
    ErrorCode PRODUCT_CATEGORY_NOT_ENABLE = new ErrorCode(1_030_501_006, "产品分类({})未启用");
    ...
    ErrorCode PRODUCT_UNIT_NOT_ENABLE = new ErrorCode(1_030_502_003, "产品单位({})未启用");
