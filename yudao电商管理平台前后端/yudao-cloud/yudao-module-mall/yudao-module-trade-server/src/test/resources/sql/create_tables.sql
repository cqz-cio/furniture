...
(
    ...
    PRIMARY KEY ("id"),
    CONSTRAINT "uk_carrier_code" UNIQUE ("tenant_id", "code", "active_record")
);
...
(
    ...
    "deleted"               bit          NOT NULL DEFAULT FALSE,
    PRIMARY KEY ("id"),
    CONSTRAINT "uk_legacy_migration_fact_order" UNIQUE ("tenant_id", "order_id")
);
...
(
    ...
    "active_record" tinyint     GENERATED ALWAYS AS (CASE WHEN "deleted" = FALSE THEN 1 ELSE NULL END),
    PRIMARY KEY ("id"),
    CONSTRAINT "uk_provider_code" UNIQUE ("tenant_id", "code", "active_record")
);
...
(
    ...
    "active_record"           tinyint     GENERATED ALWAYS AS (CASE WHEN "deleted" = FALSE THEN 1 ELSE NULL END),
    PRIMARY KEY ("id"),
    CONSTRAINT "uk_shipment_no" UNIQUE ("tenant_id", "shipment_no", "active_record"),
...
(
    ...
    "active_record" tinyint       GENERATED ALWAYS AS (CASE WHEN "deleted" = FALSE THEN 1 ELSE NULL END),
    PRIMARY KEY ("id"),
    CONSTRAINT "uk_shipment_item" UNIQUE ("tenant_id", "shipment_id", "order_item_id", "active_record"),
...
(
    ...
    "active_record"   tinyint       GENERATED ALWAYS AS (CASE WHEN "deleted" = FALSE THEN 1 ELSE NULL END),
    PRIMARY KEY ("id"),
    CONSTRAINT "uk_shipment_package_no" UNIQUE ("tenant_id", "shipment_id", "package_no", "active_record"),
    CONSTRAINT "uk_package_tracking" UNIQUE ("tenant_id", "carrier_id", "tracking_number", "active_record"),
...
(
    ...
    "active_record"        tinyint      GENERATED ALWAYS AS (CASE WHEN "deleted" = FALSE THEN 1 ELSE NULL END),
    PRIMARY KEY ("id"),
    CONSTRAINT "uk_shipment_leg_sequence" UNIQUE ("tenant_id", "shipment_id", "sequence_no", "active_record")
);
...
(
    ...
    CONSTRAINT "uk_tracking_status_mapping" UNIQUE
        ("tenant_id", "provider_code", "carrier_code", "provider_status_normalized", "mapping_version", "active_record")
);
...
(
    ...
    "active_record"      tinyint       GENERATED ALWAYS AS (CASE WHEN "deleted" = FALSE THEN 1 ELSE NULL END),
    PRIMARY KEY ("id"),
    CONSTRAINT "uk_tracking_event_external" UNIQUE ("tenant_id", "provider_id", "external_event_id", "active_record"),
    CONSTRAINT "uk_tracking_event_hash" UNIQUE ("tenant_id", "provider_id", "event_hash", "active_record"),
...
(
    ...
    "active_record"            tinyint      GENERATED ALWAYS AS (CASE WHEN "deleted" = FALSE THEN 1 ELSE NULL END),
    PRIMARY KEY ("id"),
    CONSTRAINT "uk_order_fulfillment_summary" UNIQUE ("tenant_id", "order_id", "active_record")
);
...
(
    ...
    "active_record"        tinyint      GENERATED ALWAYS AS (CASE WHEN "deleted" = FALSE THEN 1 ELSE NULL END),
    PRIMARY KEY ("id"),
    CONSTRAINT "uk_fulfillment_idempotency" UNIQUE ("tenant_id", "operation", "idempotency_key_hash", "active_record")
);
...
(
    ...
    "active_record"   tinyint      GENERATED ALWAYS AS (CASE WHEN "deleted" = FALSE THEN 1 ELSE NULL END),
    PRIMARY KEY ("id"),
    CONSTRAINT "uk_fulfillment_outbox_event_id" UNIQUE ("tenant_id", "event_id", "active_record")
);
