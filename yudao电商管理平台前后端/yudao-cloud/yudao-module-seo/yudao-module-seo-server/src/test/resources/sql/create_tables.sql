CREATE TABLE IF NOT EXISTS website_page (
  ...
  site_id bigint NOT NULL, page_key varchar(64) NOT NULL, locale varchar(32) NOT NULL,
  schema_version int NOT NULL, draft_json varchar(600000) NOT NULL, draft_version int NOT NULL,
  published_revision_id bigint,
  creator varchar(64) NOT NULL DEFAULT '', create_time timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  updater varchar(64) NOT NULL DEFAULT '', update_time timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  deleted boolean NOT NULL DEFAULT FALSE, tenant_id bigint NOT NULL,
  UNIQUE (tenant_id, site_id, page_key, locale, deleted)
);
CREATE TABLE IF NOT EXISTS website_page_revision (
  id bigint NOT NULL GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
  page_id bigint NOT NULL, revision int NOT NULL, schema_version int NOT NULL, content_json varchar(600000) NOT NULL,
  creator varchar(64) NOT NULL DEFAULT '', create_time timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  updater varchar(64) NOT NULL DEFAULT '', update_time timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  deleted boolean NOT NULL DEFAULT FALSE, tenant_id bigint NOT NULL,
...
CREATE TABLE IF NOT EXISTS website_code_config (
  ...
  draft_json varchar(600000) NOT NULL,
  published_json varchar(600000) DEFAULT NULL,
  ...
  active_record tinyint GENERATED ALWAYS AS (CASE WHEN deleted = FALSE THEN 1 ELSE NULL END),
  PRIMARY KEY (id),
  UNIQUE (tenant_id, site_id, active_record)
);
...
CREATE TABLE IF NOT EXISTS website_code_history (
  ...
  snapshot_json varchar(600000) NOT NULL,
  creator varchar(64) NOT NULL DEFAULT '',
  create_time timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  updater varchar(64) NOT NULL DEFAULT '',
  update_time timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
...
CREATE TABLE IF NOT EXISTS "website_media" (
 ...
 "url" varchar(1024) NOT NULL, "width" int, "height" int, "archived" boolean NOT NULL DEFAULT FALSE,
 "creator" varchar(64) NOT NULL DEFAULT '', "create_time" timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
 "updater" varchar(64) NOT NULL DEFAULT '', "update_time" timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
 "deleted" boolean NOT NULL DEFAULT FALSE, "tenant_id" bigint NOT NULL
);
