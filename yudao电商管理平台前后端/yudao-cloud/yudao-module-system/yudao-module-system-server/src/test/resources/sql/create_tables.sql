...
CREATE TABLE IF NOT EXISTS "system_tenant" (
    ...
    "website_product_fields" varchar(1024) NOT NULL DEFAULT 'category,badges,introduction,skuCode,collection,heroNote,fabricSelector,optionGroups,highlights,description,itemNo,material,color,finish,dimension,service,sample,packing,accordions,skuProperties,relatedProducts,relatedLinks',
