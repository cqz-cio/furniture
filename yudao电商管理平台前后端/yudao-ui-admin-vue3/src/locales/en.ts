export default {
  ...
  login: {
    ...
    tenantSelectPlaceholder: 'Select a tenant',
    tenantListLoading: 'Loading tenants...',
    tenantListEmpty: 'No available tenants. Contact an administrator.',
    tenantListLoadFailed: 'Failed to load tenants. Open the list to retry.',
