...
import { filterFurnitureLiteFixedRoutes } from '@/config/furnitureLite'
import remainingRouter from './modules/remaining'

const furnitureLiteRemainingRouter = filterFurnitureLiteFixedRoutes(remainingRouter)

// 创建路由实例
const router = createRouter({
  history: createWebHistory(import.meta.env.VITE_BASE_PATH), // createWebHashHistory URL带#，createWebHistory URL不带#
  strict: true,
  routes: furnitureLiteRemainingRouter as RouteRecordRaw[],
  scrollBehavior: () => {
